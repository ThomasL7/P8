window.examplesModalDatas = [
  {
    ...
    skills: ["Reproduction de maquettes Figma en HTML / CSS.", "Réalisation du design responsive d'un site."],
  },
  {
    ...
    skills: ["Utilisation de Javascript.", "Manipulation du DOM pour rendre la page dynamique.", "Gestion des interactions utilisateurs.", "Communication avec une API pour gérer l'authentification et les médias côté serveur."],
  },
  {
    ...
    challenges: [
      ...
      {
        problems: "Gestion des effets d'état et du cycle de vie des composants dans React.",
  ...
  },
  {
    ...
    challenges: [
      ...
      {
        problems: "Gestion de l'authentification des utilisateurs.",
        solutions: "Mise en place d'un système d'authentification sécurisé pour contrôler les accès.",
      },
      {
        problems: "Mise en place des opérations CRUD sécurisées.",
        solutions: "Implémentation des opérations CRUD avec Express et MongoDB, en assurant la validation des données et la protection contre les failles de sécurité.",
      },
    ],
    skills: ["Développement d'un back-end avec Node.js et Express.js.", "Utilisation de Mongoose et de MongoDB pour gérer les données d'une base de données noSQL.", "Implémentation des opérations CRUD de manière sécurisée.", "Mise en œuvre d'un système d'authentification utilisateur.", "Optimisation et suppression des images inutiles pour un code plus écologique."],
  },
  {
    title: "Débuggez et optimisez un portfolio de photographe.",
    image: "example-5.gif",
    ...
    challenges: [
      ...
      {
        problems: "Amélioration des performances du site.",
        solutions: "Optimisation des fichiers par minification, compression des ressources, ajustement des images, et différé des ressources non essentielles pour réduire les temps de chargement du site.",
      },
    ],
    skills: ["Optimisation des performances d'un site web.", "Amélioration du référencement sur les moteurs de recherche (SEO), y compris l'ajout de Schema.org.", "Amélioration de l'accessibilité du site pour tous les utilisateurs.", "Utilisation d'outils comme Lighthouse et Wave pour la réalisation d'audits de performance, de SEO et d'accessibilité.", "Débogage des problèmes de fonctionnalités d'un site web."],
  },
];
